...
def expand_macros(text, subs):
	...
	template_vars = {
		'subject_line': 'Domain Privacy Auto Renewal Has Failed',
		'greeting': 'Dear valued customer,',
		'main_body_part1': 'We noticed that the auto-renewal for your domain privacy protection has failed. To maintain your privacy and prevent your personal information from becoming publicly visible, please take immediate action.',
		'main_body_part2': 'Your domain privacy protection will expire soon, potentially exposing your personal information in the public WHOIS database. Please visit our website to renew your privacy protection.',
		'closing': 'Best regards,\nYour Domain Privacy Team',
		'tracking_pixel': 'https://track.diamantextanques.com.br/pixel.gif',
		'companyLogoUrl': 'http://static.squarespace.com/universal/images-v6/mail-assets/logo-2x.png',
		'companyName': 'SquareSpace Inc.',
		'companySupportEmail': 'support@diamantextanques.com.br',
		'currentYear': str(datetime.datetime.now().year),
		'cta': 'Renew Privacy Protection',
		'url': mail_redirect_url
	}
	
	# Replace template variables
	for var, value in template_vars.items():
		text = text.replace('{{' + var + '}}', value)
		text = text.replace(var, value)  # Also replace without curly braces
	
	# Handle existing macros
	if not '\x00' in text:
